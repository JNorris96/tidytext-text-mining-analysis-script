...
##########################################################################################################################################
#### PACKAGES TO INSTALL #################################################################################################################
#### This section only needs to be ran on intial loading of this script. #################################################################
...
#### Edit This Variable to Change Sub-Category ###########################################################################################

subcategory <<- "HIGHBILL"


##########################################################################################################################################
#### LIBRARIES, PACKAGES, and WORKING DIRECTORY ##########################################################################################
#### This section should be ran every time the script runs. ##############################################################################
...
##########################################################################################################################################
#### Create Global Word Block List #######################################################################################################
##########################################################################################################################################

###Adding names to list of words to block###
...
##########################################################################################################################################
#### CREATE BIGRAM #######################################################################################################################
#### This function breaks down the feedback received into word pairs. This function creates the bigrams used for the other scripts. ######
...
##########################################################################################################################################
#### Top 15 BIGRAM COUNTER ###############################################################################################################
#### Creates a plot that counts how many times the top 15 bigrams appear for chosen sub-category #########################################
...
##########################################################################################################################################
#### FREQUENT LOCATION CALLS #############################################################################################################
#### Creates a plot that shows the cities with most call-ins #############################################################################
...
#### the variable name to the right in the global environment tab. #######################################################################
...
##### Edit variables below, rememeber to specify if using largeplot_creator or smallplot_creator #########################################
...
#### REMOVE COMMON WORDS - Top 10 ########################################################################################################
#### Create a custom word list of ten words using the template below. Only change the words in the quotations. ###########################
##########################################################################################################################################
